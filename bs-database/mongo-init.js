...
db.dailymenus.insertMany([{
  title: "Menu du jour",
  active: true,
  pdf: "http://localhost/api/upload/document/Menu_1641246290792.pdf"
}]);
...
db.menus.insertMany(
  [{
    ...
    language: "en",
    category: "main",
    image: "http://localhost/api/upload/image/restaurant_vegetarien_1641221143733.jpg"
  }, {
    title: "Poulet aigre-doux",
    price: 3,
    image: "http://localhost/api/upload/image/restaurant_aigredoux_1641221143729.jpg",
    ...
    title: "Poulet Cajou",
    price: 19,
    image: "http://localhost/api/upload/image/restaurant_cajou_1641221143725.jpg",
    ...
    title: "Tako",
    price: 12,
    image: "http://localhost/api/upload/image/restaurant_tako_1641283880350.jpg",
    ...
    title: "Poulet Satay",
    price: 12,
    image: "http://localhost/api/upload/image/restaurant_satay_1641283910221.jpg",
    ...
    title: "Spring Rolls",
    price: 9,
    image: "http://localhost/api/upload/image/restaurant_printemps_1641284016553.jpg",
    ...
    title: "Apple Donut",
    price: 9,
    image: "http://localhost/api/upload/image/restaurant_pomme_1641284057868.jpg",
    ...
    title: "Red Curry",
    price: 25,
    image: "http://localhost/api/upload/image/restaurant_curryrouge2_1641284131703.jpg",
    ...
    price: 13,
    image: "http://localhost/api/upload/image/restaurant_soup_1641284222032.jpg",
...
db.promotions.insertMany([{
  ...
  image: "http://localhost/api/upload/image/promotion_fondue_1641198942771.jpg",
  ...
  image: "http://localhost/api/upload/image/promotion_luge_1641198993725.jpg",
  ...
  title: "New Year Bar",
  subtitle: "The truck",
  image: "http://localhost/api/upload/image/promotion_bar_1641199060782.jpg",
  description: "Discover our new year's bar!",
  pdf: "http://localhost/api/upload/document/Menu_1641208245826.pdf",
  language: "en"
}, {
  title: "Ski World Cup",
  subtitle: "Chuenis",
  image: "http://localhost/api/upload/image/promotion_weltskicup_1641199189479.jpg",
